 ...
 * @author Admin
 */
public class NikeFactoryTest {
    
    public NikeFactoryTest() {
    }
    ...
    /**
     * Test of getAdidasProduct method, of class NikeFactory.
     */
    @Test
    public void testGetAdidasProduct() {
        System.out.println("getAdidasProduct");
        String product = "";
        NikeFactory instance = new NikeFactory();
    ...
    /**
     * Test of getNikeProduct method, of class NikeFactory.
     */
    @Test
